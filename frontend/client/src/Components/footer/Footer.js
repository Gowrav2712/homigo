      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            ...
            <StyledList>
              <li>
                <FooterLink href="https://wa.me/919980469297?text=Hello%20Homigo%20Support" target="_blank" rel="noopener noreferrer">
                  WhatsApp: +91 9980469297
                </FooterLink>
              </li>
              <li>
                <FooterLink href="mailto:homigo24@gmail.com" target="_blank" rel="noopener noreferrer">
                  Email: homigo24@gmail.com
                </FooterLink>
              </li>
              <li>
                <Typography variant="body2" sx={{ fontSize: '14px', lineHeight: '24px', color: 'text.muted', mt: 1 }}>
