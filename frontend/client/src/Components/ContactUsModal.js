...
const ContactUsModal = ({ open, onClose }) => {
  ...
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Hello Homigo Team! I would like to inquire about your services.");
    window.open(`https://wa.me/${whatsappNumber}?text=${message}`, '_blank');
  };

  const handleEmailClick = () => {
    window.open(`mailto:${email}?subject=Homigo%20Customer%20Support%20Inquiry`, '_blank');
  };
    ...
    >
      ...
      <DialogContent sx={{ pt: 1 }}>
        <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
          We're here to help! Reach out to us directly via WhatsApp, Email, or visit our office.
        </Typography>
