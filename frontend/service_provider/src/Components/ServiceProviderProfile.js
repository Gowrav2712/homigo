...
const ServiceProviderProfile = () => {
  ...
  const [allMainServices, setAllMainServices] = useState([]);
  ...
  const handleSubmit = async (e) => {
    ...
    const selectedMainServiceId = typeof profileData.main_service === 'object' 
      ? profileData.main_service?.id 
      : profileData.main_service;
    ...
    const formData = {
      ...
      main_service: selectedMainServiceId
    };
    ...
    try {
      ...
      if (selectedMainServiceId) {
        localStorage.setItem('mainServiceId', selectedMainServiceId);
      }
                    ...
                    <Grid container rowSpacing={1} columnSpacing={2}>
                      ...
                      <Grid size={12}>
                        <TextField
                          ...
                          label="Main Service"
                          name="main_service"
                          value={typeof profileData.main_service === 'object' ? profileData.main_service?.id || '' : profileData.main_service || ''}
                          onChange={handleInputChange}
                          disabled={!isEditing}
