...
export default function EnhancedOrderDashboard() {
  ...
  return (
    <Container maxWidth="xl" sx={{ py: { xs: 2, md: 4 }, my: { xs: 4, md: 8 } }}>
      <Typography variant="h3" gutterBottom sx={{ mb: 4, fontWeight: 600, color: '#2c3e50', textAlign: "center", fontSize: { xs: '1.75rem', sm: '2.5rem', md: '3rem' } }}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6}>
                <StatCard>
                  ...
                  <Typography variant="h4" sx={{ fontWeight: 'bold', color: '#34A853', fontSize: { xs: '1.5rem', sm: '2rem' } }}>
