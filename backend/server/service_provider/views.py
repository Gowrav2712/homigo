...
class LoginView(APIView):
    ...
    def post(self, request):
        ...
        # Gate 1: Is this IP currently rate-limited?
        ...
        if serializer.is_valid():
            ...
            # Success — reset the failed attempt counter for this IP + email
        ...
        if count >= getattr(settings, 'LOGIN_MAX_ATTEMPTS', 5):
            # Threshold reached — create security event, send email, block IP
