...
class ServiceProviderCreateUpdateSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        new_main_service = validated_data.get('main_service')
        if new_main_service and new_main_service != instance.main_service:
            # Delete provider services from previous main service category
